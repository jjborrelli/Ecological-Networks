...
```{r locationSPLIT}
places <- read.csv("C:/Users/jjborrelli/Desktop/GitHub/Ecological-Networks/SouthernOcean/locationLEVELS.csv")
for(i in 1:nrow(s.ocean)){
  s.ocean$NEW_LOCATION[i] <- places$replace.with[as.numeric(s.ocean$LOCATION[i])]
}
